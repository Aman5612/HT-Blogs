...
export class UtilService {
  ...
  fetchIndexValue(updatedIndex) {
    this.indexValue.next(updatedIndex);
  }
  fetchFilterValue(updatedValue) {
    this.filterValue.next(updatedValue);
  }
  fetchFilterTwoValue(updatedValue) {
    this.filterTwoValue.next(updatedValue);
  }
  fetchFilterThreeValue(updatedValue) {
  ...
  getUserProfile() {
    if (this.getItem(this.USER_PROFILE) != null && this.getItem(this.USER_PROFILE) != undefined && this.getItem(this.USER_PROFILE) != '') {
      return JSON.parse(this.getItem(this.USER_PROFILE));
    } else {
      return null;
    }
  }
  ...
  getUserID() {
    if (this.getItem(this.USER_PROFILE) != null && this.getItem(this.USER_PROFILE) != undefined && this.getItem(this.USER_PROFILE) != '') {
      return JSON.parse(this.getItem(this.USER_PROFILE)).id;
    } else {
      return null;
    }
  }
  ...
  getDiffInSecs(dateStr1, dateStr2) {
  ...
  getDifferenceInMins(dateStr1, dateStr2) {
    const date1 = new Date(dateStr1);
    const date2 = new Date(dateStr2);
    const differenceInMilliseconds = Math.abs(date2.getTime() - date1.getTime());
